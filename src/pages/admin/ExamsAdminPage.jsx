...
const EXAM_PAGES = [
  ...
  { slug: 'sbi-cbo',              name: 'SBI CBO',                    category: 'Bank & Insurance', status: 'Live', vacancies: '~2,050',  difficulty: 'High' },
  { slug: 'sbi-junior-associates',name: 'SBI Junior Associates',      category: 'Bank & Insurance', status: 'Live', vacancies: '~6,589',  difficulty: 'Medium' },
  { slug: 'sbi-so',               name: 'SBI SO',                     category: 'Bank & Insurance', status: 'Live', vacancies: 'Varies',   difficulty: 'High' },
  { slug: 'ibps-so',              name: 'IBPS SO',                    category: 'Bank & Insurance', status: 'Live', vacancies: '~1,000',  difficulty: 'High' },
  { slug: 'bob-lbo',              name: 'Bank of Baroda LBO',         category: 'Bank & Insurance', status: 'Live', vacancies: '~2,500',  difficulty: 'Medium' },
  { slug: 'pnb-lbo',              name: 'Punjab National Bank LBO',   category: 'Bank & Insurance', status: 'Live', vacancies: '~750',    difficulty: 'Medium' },
  { slug: 'union-bank-lbo',       name: 'Union Bank of India LBO',    category: 'Bank & Insurance', status: 'Live', vacancies: '~1,500',  difficulty: 'Medium' },
  { slug: 'indian-bank-lbo',      name: 'Indian Bank LBO',            category: 'Bank & Insurance', status: 'Live', vacancies: '~300',    difficulty: 'Medium' },
  { slug: 'punjab-sindh-bank-lbo',name: 'Punjab & Sindh Bank LBO',    category: 'Bank & Insurance', status: 'Live', vacancies: '~1,000',  difficulty: 'Medium' },
  { slug: 'central-bank-apprentice', name: 'Central Bank of India Apprentice', category: 'Bank & Insurance', status: 'Live', vacancies: '~4,500', difficulty: 'Low' },
  { slug: 'bob-apprentice',       name: 'Bank of Baroda Apprentice',  category: 'Bank & Insurance', status: 'Live', vacancies: '~5,000',  difficulty: 'Low' },
  { slug: 'union-bank-apprentice',name: 'Union Bank of India Apprentice', category: 'Bank & Insurance', status: 'Live', vacancies: '~1,865', difficulty: 'Low' },
  { slug: 'iob-apprentice',       name: 'Indian Overseas Bank Apprentice', category: 'Bank & Insurance', status: 'Live', vacancies: '~750', difficulty: 'Low' },
  { slug: 'south-indian-bank-po',    name: 'South Indian Bank PO',    category: 'Bank & Insurance', status: 'Live', vacancies: 'Not disclosed', difficulty: 'Medium' },
  { slug: 'south-indian-bank-clerk', name: 'South Indian Bank Clerk', category: 'Bank & Insurance', status: 'Live', vacancies: '~537',    difficulty: 'Medium' },
  { slug: 'karnataka-bank-po',       name: 'Karnataka Bank PO',       category: 'Bank & Insurance', status: 'Live', vacancies: 'Not disclosed', difficulty: 'Medium' },
  { slug: 'karnataka-bank-clerk',    name: 'Karnataka Bank Clerk',    category: 'Bank & Insurance', status: 'Live', vacancies: 'Not disclosed', difficulty: 'Medium' },
  { slug: 'nainital-bank-po',        name: 'Nainital Bank PO',        category: 'Bank & Insurance', status: 'Live', vacancies: '~40',     difficulty: 'Medium' },
  { slug: 'nainital-bank-clerk',     name: 'Nainital Bank Clerk',     category: 'Bank & Insurance', status: 'Live', vacancies: '~71',     difficulty: 'Medium' },
  { slug: 'idbi-jam',             name: 'IDBI Junior Assistant Manager', category: 'Bank & Insurance', status: 'Live', vacancies: '~1,100', difficulty: 'Medium' },
  { slug: 'idbi-executive',       name: 'IDBI Executives',            category: 'Bank & Insurance', status: 'Live', vacancies: '~1,000',  difficulty: 'Low' },
  { slug: 'idbi-so',              name: 'IDBI SO',                    category: 'Bank & Insurance', status: 'Live', vacancies: '~33',     difficulty: 'High' },
  // SSC
